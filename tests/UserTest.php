...
class UserTest extends testCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$user = new User(0, 'Az12@4567', 'Pat', 'ateee', 'mon@mail.com', '2020-09-01', 'ENSEIGNANT', 0);
    }
    ...
    public function testCreateUserStudentNumber()
    {
        $this->assertEquals(0, self::$user->getStudentNumber());
