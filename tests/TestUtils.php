...
class TestUtils
{
    ...
    public static function CreateDataTestSet()
    {
        ...
        ControllerDataBase::exec('INSERT INTO `user` (`key`, `id`, `password`, `first_name`, `last_name`, `mail`, `role`, `date_naissance`, student_number) VALUES (\'7\', \'SMoi\', \'$2y$10$dvPYMpa4mXt3CRz8vifbY.yJsTQnpGJDHJ6J5gB.XdhF6F1z322t6\', \'Supprime\', \'Moi\', \'Supprime.Moi@mail.com\', \'ENSEIGNANT\', \'2020-09-01\', 0)');
        ...
        ControllerDataBase::exec('INSERT INTO `user` (`key`, `id`, `password`, `first_name`, `last_name`, `mail`, `role`, `date_naissance`, student_number) VALUES (\'8\', \'MSupprime\', \'$2y$10$dvPYMpa4mXt3CRz8vifbY.yJsTQnpGJDHJ6J5gB.XdhF6F1z322t6\', \'Moi\', \'Supprime\', \'Moi.Supprime@mail.com\', \'ETUDIANT\', \'2020-09-01\', 123465987)');
