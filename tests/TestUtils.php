...
class TestUtils
{
    ...
    public static function CreateDataTestSet()
    {
        ...
        ControllerDataBase::exec('INSERT INTO `user` (`key`, `id`, `password`, `first_name`, `last_name`, `mail`, `role`, `date_naissance`, student_number) VALUES (\'3\', \'SMoi\', \'$2y$10$dvPYMpa4mXt3CRz8vifbY.yJsTQnpGJDHJ6J5gB.XdhF6F1z322t6\', \'Supprime\', \'Moi\', \'Supprime.Moi@mail.com\', \'ENSEIGNANT\', \'2020-09-01\', 0)');

        ControllerDataBase::exec('INSERT INTO `user` (`key`, `id`, `password`, `first_name`, `last_name`, `mail`, `role`, `date_naissance`, student_number) VALUES (\'4\', \'GHotine\', \'$2y$10$dvPYMpa4mXt3CRz8vifbY.yJsTQnpGJDHJ6J5gB.XdhF6F1z322t6\', \'Guy\', \'Hotine\', \'Guy.Hotine@mail.com\', \'ETUDIANT\', \'2020-09-01\', 123456789)');
        ControllerDataBase::exec('INSERT INTO `user` (`key`, `id`, `password`, `first_name`, `last_name`, `mail`, `role`, `date_naissance`, student_number) VALUES (\'5\', \'DDormi\', \'$2y$10$dvPYMpa4mXt3CRz8vifbY.yJsTQnpGJDHJ6J5gB.XdhF6F1z322t6\', \'Djamal\', \'Dormi\', \'Djamal.Dormi@mail.com\', \'ETUDIANT\', \'2020-09-01\', 987654321)');
        ControllerDataBase::exec('INSERT INTO `user` (`key`, `id`, `password`, `first_name`, `last_name`, `mail`, `role`, `date_naissance`, student_number) VALUES (\'6\', \'MSupprime\', \'$2y$10$dvPYMpa4mXt3CRz8vifbY.yJsTQnpGJDHJ6J5gB.XdhF6F1z322t6\', \'Moi\', \'Supprime\', \'Moi.Supprime@mail.com\', \'ETUDIANT\', \'2020-09-01\', 123465987)');

        ControllerDataBase::exec('INSERT INTO `user` (`key`, `id`, `password`, `first_name`, `last_name`, `mail`, `role`, `date_naissance`, student_number) VALUES (\'7\', \'CCépacaré\', \'$2y$10$dvPYMpa4mXt3CRz8vifbY.yJsTQnpGJDHJ6J5gB.XdhF6F1z322t6\', \'Cicéron\', \'Cépacaré\', \'Cicéron.Cépacaré@mail.com\', \'EQUIPE_ADMINISTRATIVE\', \'2020-09-01\', 0)');

        ControllerDataBase::exec('INSERT INTO `user` (`key`, `id`, `password`, `first_name`, `last_name`, `mail`, `role`, `date_naissance`, student_number) VALUES (\'8\', \'AIstrateur\', \'$2y$10$dvPYMpa4mXt3CRz8vifbY.yJsTQnpGJDHJ6J5gB.XdhF6F1z322t6\', \'Admin\', \'Istrateur\', \'Admin.Istrateur@mail.com\', \'ADMINISTRATEUR\', \'2020-09-01\', 0)');
        ...
        ControllerDataBase::exec('INSERT INTO module (`key`, name) VALUES (\'3\', \'Supprime Moi\')');
