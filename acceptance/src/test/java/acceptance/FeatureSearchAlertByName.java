...
public class FeatureSearchAlertByName
{
    ...
    @When("^The user enter a student name in the search bar$")
    public void theAdminStaffEnterAStudentNameInTheSearchBar()
    {
        m_driver.findElement(By.id("tableSearch")).click();
        m_driver.findElement(By.id("tableSearch")).sendKeys("Dormi");
    }

    @Then("^The name of the student appear in the search result$")
